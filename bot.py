...
async def topup(msg: types.Message):
    await msg.reply("🔐 Отправьте TON/USDT вручную на ваш криптокошелёк и пришлите сюда чек (фото или текст).
"
                    "💬 Бот активирует сумму после ввода вручную. Введите сумму, которую пополнили (только число).")
